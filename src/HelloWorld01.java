...
public class HelloWorld01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(); // 아무것도 보여주지 않기 단ㅡ 줄바꿈만 하기
		// 큰 따옴표로 묶인 것은 무엇이든지 모두
		// 문자열(String)이라고 한다.
		// 문자열은 보이는 그대로이다.
		System.out.println("Hello"); // Hello라는 글자를 보여주기 
		System.out.println("30+40"); // 30+40이라는 글자를 보여주기
		// 문자열들을 덧셈(연산)하면
		// 문자열들을 서로 순서대로 연결하여
		// 1개의 문자열로 만들어라
		// 그리고 그 문자열을 보여달라
